...
func (a *OrgSecretApiService) DeleteOrgScopedSecret(ctx context.Context, org string, secret string, localVarOptionals *OrgSecretApiDeleteOrgScopedSecretOpts) (SecretResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/org/{org}/secrets/{secret}"
	localVarPath = strings.Replace(localVarPath, "{"+"org"+"}", fmt.Sprintf("%v", org), -1)
...
/*
OrgSecretApiService Validate unique secret slug
Validates org scoped secret slug is unique
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param org Slug field of the organization the resource is scoped to
 * @param secret Slug field of the secret
 * @param optional nil or *OrgSecretApiValidateUniqueOrgScopedSecretSlugOpts - Optional Parameters:
     * @param "Account" (optional.String) -  Slug field of the account the resource is scoped to. This is required for Authorization method other than x-api-key header. If you are using x-api-key header this can be skipped.
@return ValidateSecretSlugResponse
*/

type OrgSecretApiValidateUniqueOrgScopedSecretSlugOpts struct {
    Account optional.String
}

func (a *OrgSecretApiService) ValidateUniqueOrgScopedSecretSlug(ctx context.Context, org string, secret string, localVarOptionals *OrgSecretApiValidateUniqueOrgScopedSecretSlugOpts) (ValidateSecretSlugResponse, *http.Response, error) {
	var (

...
type FilterResourceGroupsApiService service
/*
FilterResourceGroupsApiService Filter Resource Groups
Returns a list of Resource Groups based on filter criteria.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Filter Resource Group request body
 * @param optional nil or *FilterResourceGroupsApiFilterResourceGroupsOpts - Optional Parameters:
...
type FilterResourceGroupsApiFilterResourceGroupsOpts struct {
...
func (a *FilterResourceGroupsApiService) FilterResourceGroups(ctx context.Context, body ResourceGroupFilterRequestBody, localVarOptionals *FilterResourceGroupsApiFilterResourceGroupsOpts) ([]ResourceGroupsResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/resource-groups/filter"

...
**LastObjectId** | **string** | Last object identifier (for Github only). | [optional] [default to null]
**BaseBranch** | **string** | Name of the default branch (this checks out a new branch titled by branch_name). | [optional] [default to null]
**LastCommitId** | **string** | Last commit identifier. | [optional] [default to null]

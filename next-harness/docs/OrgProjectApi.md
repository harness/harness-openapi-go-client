...
------------- | ------------- | -------------
[**CreateOrgScopedProject**](OrgProjectApi.md#CreateOrgScopedProject) | **Post** /v1/orgs/{org}/projects | Create a project
 ...
 **project** | [**optional.Interface of []string**](string.md)| Identifier field of the projects the resource is scoped to | 
 ...
 **onlyFavorites** | **optional.Bool**| Enable this field to fetch only the entities that are marked as favorites. | 

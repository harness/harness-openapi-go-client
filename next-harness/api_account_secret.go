...
/*
AccountSecretApiService Validate secret reference
Validates if the secret at the secretManager path can be referenced
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AccountSecretApiValidateAccountSecretRefOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SecretRequest) -  Details of the secret reference
     * @param "HarnessAccount" (optional.String) -  Identifier field of the account the resource is scoped to. This is required for Authorization methods other than the x-api-key header. If you are using the x-api-key header, this can be skipped.
@return SecretValidationResponse
*/

type AccountSecretApiValidateAccountSecretRefOpts struct {
    Body optional.Interface
    HarnessAccount optional.String
}

func (a *AccountSecretApiService) ValidateAccountSecretRef(ctx context.Context, localVarOptionals *AccountSecretApiValidateAccountSecretRefOpts) (SecretValidationResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/secrets/validate-secret-ref"
